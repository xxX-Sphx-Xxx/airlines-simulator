...
def hub_destination(latitude1, longitude1, latitude2, longitude2):
...
print (round(hub_distance(latitude1, longitude1, latitude2, longitude2)))

def aff_heure(heure,minute):
  print("{}:{}".format(heure,minute))
